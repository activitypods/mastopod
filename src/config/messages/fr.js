...
export default {
  app: {
    ...
    authorization: {
      ...
      access_resources_of_type:
        "%{access_right} les ressources de type %{type}",
      read: "Lire",
      append: "Enrichir",
      write: "Écrire",
      control: "Administrer",
    ...
    helper: {
      ...
      profile_visibility:
        "Votre profil n'est visible que des personnes que vous avez accepté dans votre réseau",
      share_contact:
        "Pour vous connecter avec une personne que vous connaissez, vous pouvez lui envoyer le lien ci-dessous.",
      location_comment:
        "Indications supplémentaires pour aider à trouver ce lieu",
      g1_tipjar_field:
      ...
      set_new_password:
        "Veuillez entrer votre adresse mail et un nouveau mot de passe ci-dessous",
      create_profile:
      ...
      authorize:
        "Autorisez-vous le site %{appDomain} à accéder à votre espace de données ?",
    ...
    notification: {
      ...
      contact_ignored:
        "Contact ignoré. Vous ne serez plus notifié de ses invitations.",
      contact_ignore_undone:
        "Vous recevrez à nouveau les invitations de ce contact.",
      login_to_connect_user:
        "Veuillez vous créer un compte pour vous connecter avec %{username}",
      ...
      profile_data_not_found:
        "Votre profil n'a pas été trouvé, veuillez vous déconnecter et vous reconnecter",
      user_not_found: "L'utilisateur %{username} n'existe pas",
      reset_password_submitted:
        "Un e-mail a été envoyé avec les instructions de réinitialisation du mot de passe",
      ...
      verified_applications_load_failed:
        "Impossible de charger la liste des applications vérifiées",
      app_uninstallation_in_progress:
        "Désinstallation de l'application en cours...",
      ...
      invite_cap_missing:
        "Impossible de générer un lien d'invitation (missing capability)",
      invite_cap_profile_fetch_error:
        "Erreur lors de la recherche du profil associé au lien d'invitation",
      pod_provider_fetch_error:
        "Erreur lors de la recherche d'autres hébergeurs : %{error}",
    ...
    validation: {
      ...
      confirmNewPassword:
        "Doit être le même que le nouveau champ de mot de passe",
      password_strength: "Force du mot de passe",
      password_too_weak:
        "Mot de passe trop faible. Augmentez la longueur ou ajoutez des caractères spéciaux.",
