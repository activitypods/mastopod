...
export default {
  app: {
    ...
    helper: {
      ...
      share_contact:
        "To connect with someone you know, you can send them the link below.",
      ...
      set_new_password:
        "Please enter your email address and a new password below",
      create_profile:
      ...
      authorize:
        "To be installed, the app %{appDomain} require the following authorizations",
    ...
    notification: {
      ...
      verified_applications_load_failed:
        "Unable to load the list of verified applications",
      app_uninstallation_in_progress:
        "Application uninstallation in progress...",
      ...
      invite_cap_fetch_error:
        "Error ocurred while fetching the invitation. It might not be valid. Error: %{error}",
      invite_cap_missing:
        "Unable to generate an invite link (missing capability)",
      invite_cap_profile_fetch_error:
        "Error while fetching the profile associated with the invite link.",
      pod_provider_fetch_error:
        "Error while looking for other pod providers: %{error}",
      contact_link_copied: "Contact link copied successfully",
      already_connected:
        "You are already connected with the person who invited you.",
    },
    user: {
      unknown: "Unknown",
      location: "At %{name}'s",
    ...
    validation: {
      ...
      password_too_weak:
        "Password too weak. Increase length or add special characters.",
